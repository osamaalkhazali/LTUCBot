    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <div id="chatMessages" class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 scroll-smooth">
            ...
            <div class="flex items-start space-x-3 message-animation">
                <div class="w-10 h-10 ltuc-primary rounded-full flex items-center justify-center flex-shrink-0">
                    <i class="fas fa-graduation-cap text-white text-sm"></i>
                </div>
                <div class="bg-white rounded-2xl rounded-tl-sm p-4 shadow-sm max-w-2xl border border-gray-100">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex gap-2 ">
                        ...
                        <div class="flex-1 relative">
                            ...
                            <!-- Character Count -->
                            <div id="charCount" class="absolute -bottom-5 right-2 text-xs text-gray-400 hidden">
                                0/1000
                            </div>
                        </div>
    ...
    <script>
        ...
        function addMessage(text, isUser = false, attachments = [], isHtml = false) {
            ...
            messageDiv.innerHTML = `
                <div class="w-10 h-10 ${isUser ? 'bg-pink-500' : 'ltuc-primary'} rounded-full flex items-center justify-center flex-shrink-0">
                    <i class="fas ${isUser ? 'fa-user' : 'fa-graduation-cap'} text-white text-sm"></i>
                </div>
                <div class="bg-white rounded-2xl ${isUser ? 'rounded-tr-sm' : 'rounded-tl-sm'} p-4 shadow-sm max-w-2xl border border-gray-100">
                    ${contentHTML}
